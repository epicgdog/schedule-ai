# Product Guide: Schedule AI

## Vision
Schedule AI is a specialized tool designed for San Jose State University (SJSU) students to build optimized course schedules. It helps students find the best professors and class times while visualizing complex prerequisite trees using interactive graphs.

## Target Audience
- **Primary:** All SJSU Students seeking an efficient way to plan their academic career.
- **Secondary:** Students in STEM majors (CS/SE) who face complex prerequisite structures.

## Core Value Proposition
- **Efficiency:** Minimize time spent manually searching for open sections and checking prerequisites.
- **Graduation Speed:** Ensure students take the right classes in the right order to graduate on time.
...
- Increased awareness of prerequisite dependencies among users.
- Improved student satisfaction with course selection and professor quality.
